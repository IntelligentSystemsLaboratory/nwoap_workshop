...
![](images/iai_hub_files/architecture.png){.absolute top=100 left=100}

## Django Application

![](images/iai_hub_files/django_app.png){.absolute top=100 left=100}

## Quarto Application

![](images/iai_hub_files/iai_quarto.png){.absolute top=100 left=100}
